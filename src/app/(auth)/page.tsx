        ...
        <main style={{ padding: "3rem" }}>
          ...
          <footer style={{ paddingTop: "50px", paddingBottom: "40px", color: "#999", fontSize: "13px", lineHeight: "2" }}>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", justifyContent: "flex-start", alignItems: "center" }}>
              <span style={LINK_STYLE}>Directory</span> &middot;
              <span style={LINK_STYLE}>About us</span> &middot;
              <span style={LINK_STYLE}>Jobs</span> &middot;
              <span style={LINK_STYLE}>Press</span> &middot;
              <span style={LINK_STYLE}>Blog</span> &middot;
              <span style={LINK_STYLE}>Legal</span> &middot;
              <span style={LINK_STYLE}>Privacy</span> &middot;
              <span style={LINK_STYLE}>Cookies</span> &middot;
              <span style={LINK_STYLE}>Charts</span> &middot;
