...
export default function SignInStep({ emailOrProfileUrl, password, onPasswordChange, onSubmit, onBack, error, isLoading, subtitle , onForgotPassword }: ISignInStepProps) {
