...
export interface IPlaylistService {
  ...
  /** Returns the playlists liked/saved by the authenticated user. */
  getLikedPlaylists(): Promise<IPlaylist[]>;
  /** Mark a playlist as liked by the authenticated user. */
  likePlaylist(playlistId: string): Promise<void>;
  /** Remove a playlist from the authenticated user's liked playlists. */
